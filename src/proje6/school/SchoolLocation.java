...
public class SchoolLocation {
    ...
    create a setPrice Method
            ...
            if the location is non of these then
            throw an exception  --> "This is not a valid location"
     ...
     ------------------------------------------------------------------------------
           ...
           Eğer location  Canada ise
            ...
            Eğer location bunlardan biri değil ise
            exception fırlatın  --> "This is not a valid location"
     */
    //-------------------------------------------------------------------------------------------------------
